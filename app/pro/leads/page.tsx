  ...
  return (
    <div className="p-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">My Leads</h1>
          <p className="text-gray-500 text-sm mt-1">{myLeads.length} leads assigned to you</p>
        </div>
      ...
      {myLeads.length === 0 ? (
        <div className="text-center py-24 text-gray-500">
          <div className="text-4xl mb-4 transition-transform hover:-translate-y-1 duration-300 inline-block">📋</div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-200 bg-gray-50/80">
                ...
                <th className="text-left text-gray-500 font-medium px-6 py-4 whitespace-nowrap">Contact</th>
                <th className="text-left text-gray-500 font-medium px-6 py-4">City</th>
                <th className="text-left text-gray-500 font-medium px-6 py-4 whitespace-nowrap">Qualification</th>
              ...
              {myLeads.map((lead, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-gray-600 whitespace-nowrap">{lead.contactNumber ?? '—'}</td>
                    <td className="px-6 py-4 text-gray-600">{lead.city ?? '—'}</td>
                    <td className="px-6 py-4 text-gray-600">{lead.lastQualification ?? '—'}</td>
                    <td className="px-6 py-4">
                      <span className={`text-xs px-2.5 py-1.5 rounded-lg border font-medium ${stage.color}`}>
                        {stage.label}
                      </span>
                    </td>
                    <td className="px-6 py-4">
