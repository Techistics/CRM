...
import { Loader2, Mail, User, MessageCircle } from 'lucide-react'
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        <div>
          ...
          <p className="mt-1 text-sm text-slate-500">
            Join the Consulty platform and start managing leads today.
          </p>
        </div>
          ...
          <div>
            ...
            {error.includes('already exists') && (
              <Button
                variant="outline"
                size="sm"
                className="mt-2 w-full border-slate-200 text-slate-700 hover:bg-slate-50"
                asChild
              >
