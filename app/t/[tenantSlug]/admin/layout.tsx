...
export default async function AdminLayout({
  ...
  const { tenant, user, role, permissions, dbUserId } = await requireTenantAdminSession()
    ...
    <SidebarProvider>
      <div className="min-h-screen bg-consulty-canvas dark:bg-consulty-canvas">
        ...
        <div className="flex min-h-screen min-w-0 flex-col lg:pl-[var(--sidebar-width)]">
          <AdminHeader user={user} tenantSlug={tenant.slug} tenantId={tenant.id} userId={dbUserId} />
