  ...
  return (
    <div className="w-full">
      <div className="mb-6">
        ...
        <p className="text-sm text-slate-500 mt-1">Leads reassigned to you by consultants — {leads.length} total</p>
      </div>
          ...
          <tbody>
            {leads.map((lead) => (
              <tr key={lead.id} className="border-b border-slate-100 dark:border-slate-800 last:border-0 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors">
                ...
                <td className="px-4 py-3">
                  <Link
                    href={`/t/${tenantSlug}/admin/leads/${lead.id}`}
            ...
            {leads.length === 0 && (
              <tr>
                <td colSpan={7} className="px-4 py-10 text-center text-slate-400 text-sm">
                  No leads have been reassigned to you yet.
                </td>
              </tr>
            )}
          </tbody>
