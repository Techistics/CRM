...
export default async function PipelineSettingsPage() {
  ...
  return (
    <div className="max-w-4xl space-y-10">
      <div>
        <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Pipeline Settings</h1>
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-crm-sm p-6 dark:bg-[a#0f172a] dark:border-slate-700">
